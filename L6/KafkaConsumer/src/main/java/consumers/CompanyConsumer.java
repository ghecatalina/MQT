    ...
    public void pollKafka(String kafkaTopicName){
        ...
        while (true){
            ...
            records.forEach(crtRecord -> {
                LOG.info("------ Company Consumer ------------- topic ={}  key = {}, value = {} => partition = {}, offset = {}",kafkaTopicName, crtRecord.key(), crtRecord.value(), crtRecord.partition(), crtRecord.offset());
            });
        }
    }
